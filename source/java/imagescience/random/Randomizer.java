...
public class Randomizer {
	...
	*/
	...
	/** Randomizes images using a uniform random variable.
		...
		@param min The minimum of the uniform distribution interval. Random numbers are generated in the open interval ({@code min},{@code max}).
		
		@param max The maximum of the uniform distribution interval. Random numbers are generated in the open interval ({@code min},{@code max}).
