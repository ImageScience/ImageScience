...
public class UniformGenerator implements RandomGenerator {
	...
	*/
	...
	/** Constructs a generator of random numbers uniformly distributed in the open interval {@code (min,max)} and initialized with a random seed.
		...
		@param min The minimum of the uniform distribution interval. If {@code min > max}, the meaning of the parameters is automatically reversed.
		
		@param max The maximum of the uniform distribution interval.
	*/
	...
	*/
	...
	/** Returns a uniform random number in the open interval {@code (min,max)}.
		...
		@return A uniform random number in the open interval {@code (min,max)}.
	*/
