...
public class Transform {
	...
	/** Copy constructor. Sets the elements of the transformation matrix to those of the given matrix.
	...
	*/
	...
	/** Element constructor. Sets the elements of the transformation matrix to the given values.
		...
		@param axx The matrix element axx.
		
		@param axy The matrix element axy.
		
		@param axz The matrix element axz.
		
		@param axt The matrix element axt.
		
		@param ayx The matrix element ayx.
		
		@param ayy The matrix element ayy.
		
		@param ayz The matrix element ayz.
		
		@param ayt The matrix element ayt.
		
		@param azx The matrix element azx.
		
		@param azy The matrix element azy.
		
		@param azz The matrix element azz.
		
		@param azt The matrix element azt.
	*/
	public Transform(
	...
	*/
	...
	/** Indicates whether the transformation matrix is equal to the given matrix.
	
		@param transform The transformation matrix to compare this matrix with.
	...
	*/
	...
	/** Sets the elements of the transformation matrix to those of the given matrix.
	...
	*/
	...
	/** Returns the transformation matrix as a 4 x 4 {@code double} array.
		...
		@return A new 4 x 4 {@code double} array containing the transformation matrix.
	*/
	public double[][] get() {
	...
	/** Returns the value of the element at the given row and column of the transformation matrix.
		
		@param row The row index. Must be {@code 0}, {@code 1}, {@code 2}, or {@code 3}.
		
		@param column The column index. Must be {@code 0}, {@code 1}, {@code 2}, or {@code 3}.
		
		@return The value of the element at the given row and column of the transformation matrix.
