...
public class Rotate {
	...
	/** Rotates an image.
		...
		@param zangle The rotation angles (in degrees) around the z-axis of the image.
		
		@param yangle The rotation angles (in degrees) around the y-axis of the image.
		
		@param xangle The rotation angles (in degrees) around the x-axis of the image.
		
		<p>The order of rotation around the different axes is the same as that of the parameters. Rotation is applied to every x-y-z subimage in a 5D image. The origin of the right-handed coordinate system in which the rotation is carried out is taken in the center of each subimage.</p>
