...
public class Translate {
	...
	/** Translates an image.
		...
		@param xtrans The translation distance (in physical units) in the x-dimension.
		
		@param ytrans The translation distance (in physical units) in the y-dimension.
		
		@param ztrans The translation distance (in physical units) in the z-dimension.
		
		<p>The translation is applied to every x-y-z subimage in a 5D image.</p>
