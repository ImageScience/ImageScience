...
public class Turn {
	...
	/** Turns an image.
		...
		@param times90z The number of times the image should be rotated 90 degrees around the z-axis.
		
		@param times90y The number of times the image should be rotated 90 degrees around the y-axis.
		
		@param times90x The number of times the image should be rotated 90 degrees around the x-axis.
		
		<p>The order of rotation is the same as the parameters. That is to say, first {@code times90z} times 90 degrees around the z-axis, then {@code times90y} times 90 degrees around the y-axis, and finally {@code times90x} times 90 degrees around the x-axis. The algorithm is applied to every x-y-z subimage in a 5D image and assumes a right-handed coordinate system, with the origin in the center of each subimage. A rotation of +90 degrees around the z-axis implies that the positive x-axis is mapped onto the positive y-axis. Similarly, a rotation of +90 degrees around the y-axis maps the positive z-axis onto the positive x-axis, and a rotation of +90 degrees around the x-axis maps the positive y-axis onto the positive z-axis.</p>
