...
public class Differentiator {
	...
	/** Computes derivatives of images.
		...
		@param xorder The order of differentiation in the x-dimension. The largest supported order is {@link #MAX_ORDER}. If {@code 0}, only smoothing is applied in that dimension, at the given {@code scale}.
		
		@param yorder The order of differentiation in the y-dimension. The largest supported order is {@link #MAX_ORDER}. If {@code 0}, only smoothing is applied in that dimension, at the given {@code scale}.
		
		@param zorder The order of differentiation in the z-dimension. The largest supported order is {@link #MAX_ORDER}. If {@code 0}, only smoothing is applied in that dimension, at the given {@code scale}.
