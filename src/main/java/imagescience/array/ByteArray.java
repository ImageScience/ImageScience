...
/** A dynamic array of {@code byte} values. Provides more flexibility than {@code byte[]} objects and more efficiency than {@code java.util.Vector<Byte>} objects. */
